...
Revision ID: e42aabb71e1b
Revises: 
Create Date: 2020-07-01 09:19:56.080140
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('in_progress', 'user', 'opponent'), server_default='in_progress', nullable=False),
